...
public:
	...
	virtual void ray_trace_gpu(uint32_t n_elements, Eigen::Vector3f* gpu_positions, Eigen::Vector3f* gpu_directions, SdfPayload* gpu_payloads, const Triangle* gpu_triangles, cudaStream_t stream) = 0;
    ...
    TriangleBvhNode* nodes() {
        return m_nodes.data();
    }

    bool m_apply_depth_mask = false;
